#!/bin/bash
######################################################################################
## Command=wget https://raw.githubusercontent.com/tar1971/turkvod/main/installer.sh -O - | /bin/sh
##
###########################################
###########################################
...
MY_IPK_PY3="enigma2-plugin-extensions-turkvod_12.00_PY3.all"
MY_URL="https://raw.githubusercontent.com/tar1971/turkvod/main"
...
rm -r /usr/lib/enigma2/python/Plugins/Extensions/TURKvod
